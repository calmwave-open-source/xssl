...
%% xtlsv1.0 and xtlsv1.1 is now also considered legacy
%% xtlsv1.3 is under development (experimental).
-define(ALL_AVAILABLE_VERSIONS, ['tlsv1.3', 'tlsv1.2', 'tlsv1.1', xtlsv1]).
-define(ALL_AVAILABLE_DATAGRAM_VERSIONS, ['dtlsv1.2', xdtlsv1]).
...
-define(ALL_TLS_RECORD_VERSIONS, ['tlsv1.2', 'tlsv1.1', xtlsv1]).
...
-record(xconfig, {ssl,               %% SSL parameters
