...
-type internal_kex_algo()          :: null | xssl:kex_algo().
...
-type old_erl_cipher_suite() :: {xssl:kex_algo(), internal_cipher(), internal_hash()} % Pre TLS 1.2 
...
suite_str_to_map(SuiteStr)->
    ...
    case string:split(Str0, "_WITH_") of
        [Rest] ->
            xtls_1_3_suite_str_to_map(Rest);
        [Kex| Rest] ->
...
xtls_1_3_suite_str_to_map(CipherStr) ->
