...
%%--------------------------------------------------------------------
-spec cache_pem_file(binary(), term()) -> {ok, term()} | {error, xssl:reason()}.
%%		    
...
%%--------------------------------------------------------------------
-spec register_session(xssl:host(), inet:port_number(), #session{}, unique | true) -> ok.
...
%%--------------------------------------------------------------------
-spec invalidate_session(xssl:host(), inet:port_number(), #session{}) -> ok.
