...
-record(static_env, {
                     role                  :: client | server,
                     user_socket           :: #xsslsocket{},
                     transport_cb          :: atom(),   % callback module
                     protocol_cb           :: xtls_gen_connection | xdtls_gen_connection,
...
-record(state, {
                ...
                connection_env        :: #connection_env{} | xssl_gen_statem:secret_printout(),
                ssl_options           :: ssl_options(),
                socket_options        :: #xsocket_options{},

                %% Handshake %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                handshake_env         :: #handshake_env{} | xssl_gen_statem:secret_printout(),
